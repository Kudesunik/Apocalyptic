...
public class ContainerPortalLvl3 extends Container{
    protected TileEntityPortalStarterLvl3 tile_entity;

    private boolean initialized;

    private EntityPlayer myPlayer;

    public ContainerPortalLvl3(TileEntityPortalStarterLvl3 tile_entity, InventoryPlayer player_inventory){
